...
Check.addEventListener("click", function(r){
    ...
    if (checkPolitica === true){
        ...
        btnEnvioCot.addEventListener("click", function(e){
            ...
            window.location.href = `https://wa.me/573142475368/?text=Hola!%2C%20soy%20${nombre}%2C%20vi%20la%20pagina%20web%20y%20mi%20mensaje%20es%3A%20${mensaje}.%0A%0AGracias%20y%20quedo%20pendiente%20de%20su%20respuesta.%0A%0AMi%20Correo%20Electr%C3%B3nico%20es%3A%20${email}`;
        });
